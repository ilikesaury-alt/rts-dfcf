...
BASE_PARAMS = {
    ...
    "weights": {
        ...
        "new_face_bottom": NEW_FACE_WEIGHTS.get("bottom_confirmed", 10),
        "new_face_volume": NEW_FACE_WEIGHTS.get("volume_surge", 15),
        ...
        "momentum_no_crash": MOMENTUM_WEIGHTS.get("no_crash", 13),
