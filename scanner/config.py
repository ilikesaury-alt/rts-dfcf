...
OLD_FACE_STRONG_PREV_LOOKBACK = 7
...
# Ultra-short-term mode thresholds
ULTRA_NEW_FACE_MIN_SCORE = 35
ULTRA_OLD_FACE_MIN_SCORE = 20
ULTRA_MOMENTUM_MIN_SCORE = 30
ULTRA_MIN_INTRADAY_SCORE = 2
