...
- Five strategies: new_face (bottom breakout), momentum (trend continuation), pullback (reversion, re-enabled 2026-07-28 as high-risk monitor to fill strong-pullback gap; today_pct≤0 + accumulated≥5%), rebound (oversold reversal), short_term (next-day sell)
